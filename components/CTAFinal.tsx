      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative"
          ...
          <div className="relative z-10 grid md:grid-cols-2 min-h-[380px]">
            ...
            <div className="flex flex-col justify-center px-10 py-16 md:px-14 md:py-20">
              <div className="flex items-center gap-4 mb-6">
                <span className="section-label">Diagnóstico gratuito</span>
                <div className="w-8 h-px" style={{ background: 'var(--gold)' }} />
              </div>
              <h2 className="text-4xl md:text-5xl leading-[1.06] text-white mb-6"
            ...
            <div className="hidden md:flex items-end justify-center relative "
              ...
              <img
                src="/homem-cta.png"
                alt=""
                className="absolute bottom-0 h-[520px] max-h-[520px] object-contain object-bottom"
              />
